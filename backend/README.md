...
## Project Structure
    ...
    ├── testapiautosetting_115899  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115899`
...
2. Clone this repo and `cd testapiautosetting_115899`
